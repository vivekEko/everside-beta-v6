          ...
          {apiData2?.data?.length > 0 ? (
            <div className="h-[260px]">
              <div className="relative flex justify-between items-start  mb-1">
                ...
                <div
                  className="cursor-pointer text-sm text-gray-500 flex justify-between   "
                ...
                >
                    ...
                    ?.map((data, index) => (
                      ...
                      >
                        <input
                          ...
                          value={data}
                          checked={
                            selectedParentClient?.includes(data) ? true : false
                          }
                          onChange={() => {
                            if (selectedParentClient?.includes(data)) {
                              console.log(data + " already exits");
                              setSelectedParentClient((selectedParentClient) =>
                  ...
                  <div className="sticky  bg-white bottom-0 left-0 right-0">
